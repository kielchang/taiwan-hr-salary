...
> **薪酬分析**（成本結構、分布與公平之 CV/Gini/Lorenz、compa-ratio 與薪資級距＋**市場行情對標**、獎金·分紅試算、年度/季度調薪試算＋**分配方法並排比較**、**薪酬趨勢儀表板（歷期快照）與年度預算追蹤**，零相依 SVG 圖表＋CSV／PDF 月報；每分頁最上方並依數據自動產生**白話「重點意見」**——直接給結論與建議，數據僅作佐證）
