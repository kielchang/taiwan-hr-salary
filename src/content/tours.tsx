...
export const TOURS: Record<string, Tour> = {
  fx: {
    ...
    steps: [
      { title: "多幣別薪資導覽", body: <>帶你走一遍外幣薪資。外幣與台幣<strong>分開計算、視作獎金、預設不進勞健保</strong>。過程中我會替你換頁並<strong>圈出該點的控制項</strong>，點下去就會自動帶你到下一步。隨時可略過。</> },
      ...
      { route: "/settings", target: "currency-center", title: "③ 新增幣別＋設匯率", body: <>在維護中心：填代碼（如 <strong>USD</strong>）、名稱、符號→「新增幣別」；下方「匯率」輸入 1 USD＝多少台幣（如 <strong>32</strong>）。<br/>台幣約當＝外幣×匯率，僅供參考、不進稅基。填好按「下一步」。</> },
