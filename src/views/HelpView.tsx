...
const FAQ: [string, string][] = [
  ...
  [
    "一個人同月做好幾個專案，成本怎麼分？",
    "到「系統設定 → 專案主檔」建立專案（可填預算與起訖），再到「每月薪資作業」的「工時分攤」設定每位員工當月各專案的時數或百分比。系統會把該員工的全載成本（含雇主負擔）依比例分攤到各專案，沒投到專案的工時歸「未分攤／間接」。在「報表→匯總報表」與「薪酬分析→專案成本」可看各專案人事成本、FTE/稼動率與預算 vs 實際；各專案合計一定等於全公司人事成本。未設定分攤者整筆計入其預設專案。",
  ],
  [
    "員工很多，可以一次匯入嗎？離職怎麼處理？",
