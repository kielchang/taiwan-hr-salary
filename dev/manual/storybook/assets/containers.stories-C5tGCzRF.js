...
可調欄寬/搜尋），快速驗證多種狀況——不用改程式碼。`,...(ce=(le=S.parameters)==null?void 0:le.docs)==null?void 0:ce.description}}};var ie,de,ue,me,pe;I.parameters={...I.parameters,docs:{...(ie=I.parameters)==null?void 0:ie.docs,source:{originalSource:`{
...
}`,...(ue=(de=I.parameters)==null?void 0:de.docs)==null?void 0:ue.source},description:{story:"小資料集（無分頁）：純示範欄位設定與合計列",...(pe=(me=I.parameters)==null?void 0:me.docs)==null?void 0:pe.description}}};var ge,fe,be;$.parameters={...$.parameters,docs:{...(ge=$.parameters)==null?void 0:ge.docs,source:{originalSource:`{
...
}`,...(be=(fe=$.parameters)==null?void 0:fe.docs)==null?void 0:be.source}}};var xe,ve,he,Te,ye;_.parameters={..._.parameters,docs:{...(xe=_.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  args: {
    標題: "人事成本組成",
    說明: "依項目分段",
    圖表: "堆疊"
...
}`,...(he=(ve=_.parameters)==null?void 0:ve.docs)==null?void 0:he.source},description:{story:"互動 Playground：右側 Controls 調整標題/說明/圖表類型。",...(ye=(Te=_.parameters)==null?void 0:Te.docs)==null?void 0:ye.description}}};var Ce,we,Ne,je,Ee;k.parameters={...k.parameters,docs:{...(Ce=k.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    分頁數: 4
  },
  argTypes: {
...
}`,...(Ne=(we=k.parameters)==null?void 0:we.docs)==null?void 0:Ne.source},description:{story:"分頁膠囊列（全站分頁切換統一元件）：右側 Controls 調整分頁數。",...(Ee=(je=k.parameters)==null?void 0:je.docs)==null?void 0:Ee.description}}};var Se,Ie,_e,ke,De;D.parameters={...D.parameters,docs:{...(Se=D.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  args: {
    分頁數: 3
  },
  argTypes: {
...
}`,...(_e=(Ie=D.parameters)==null?void 0:Ie.docs)==null?void 0:_e.source},description:{story:"互動 Playground：右側 Controls 調整分頁數量。",...(De=(ke=D.parameters)==null?void 0:ke.docs)==null?void 0:De.description}}};var Fe,Re,Pe;L.parameters={...L.parameters,docs:{...(Fe=L.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  render: () => {
    const Demo = () => {
...
}`,...($e=(Ve=B.parameters)==null?void 0:Ve.docs)==null?void 0:$e.source}}};const bn=["資料表_DataTable","互動測試","資料表_精簡","圖表卡_ChartCard","圖表卡_互動","分頁膠囊_TabPills","分頁_互動","對話框_Dialog","分頁_Tabs"];export{bn as __namedExportsOrder,fn as default,S as 互動測試,B as 分頁_Tabs,D as 分頁_互動,k as 分頁膠囊_TabPills,$ as 圖表卡_ChartCard,_ as 圖表卡_互動,L as 對話框_Dialog,V as 資料表_DataTable,I as 資料表_精簡};
