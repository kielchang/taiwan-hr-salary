...
}`,...(_e=(ye=S.parameters)==null?void 0:ye.docs)==null?void 0:_e.source}}};const Ae=["互動","唯讀文字","已變更_文字","金額","已變更_金額","數字_含小數","已變更_數字","比率","下拉","是否_分段","單選_Radio","多選_MultiSelect","負金額_帳務","數字帶單位","日期","鎖定","新增模式"];export{Ae as __namedExportsOrder,ze as default,p as 下拉,o as 互動,t as 唯讀文字,v as 單選_Radio,g as 多選_MultiSelect,u as 已變更_數字,s as 已變更_文字,c as 已變更_金額,d as 數字_含小數,k as 數字帶單位,S as 新增模式,h as 日期,b as 是否_分段,m as 比率,x as 負金額_帳務,i as 金額,j as 鎖定};
