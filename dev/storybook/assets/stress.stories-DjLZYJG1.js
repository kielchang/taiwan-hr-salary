...
}`,...(ae=(re=x.parameters)==null?void 0:re.docs)==null?void 0:ae.source}}};const Ge=["欄位_超長文字","欄位_超長標籤","欄位_超大金額","欄位_radio多且長","欄位_多選超多項","欄位_下拉長選項","變更摘要_超多筆","資料表_多欄超寬","標籤_超長","步驟_很多步","圖表_柏拉圖多類別","圖表_堆疊多段"];export{Ge as __namedExportsOrder,De as default,x as 圖表_堆疊多段,v as 圖表_柏拉圖多類別,h as 標籤_超長,m as 欄位_radio多且長,p as 欄位_下拉長選項,u as 欄位_多選超多項,i as 欄位_超大金額,d as 欄位_超長文字,c as 欄位_超長標籤,y as 步驟_很多步,g as 變更摘要_超多筆,A as 資料表_多欄超寬};
